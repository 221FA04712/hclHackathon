  ...
  return (
    <div className="max-w-[1152px] min-h-[852px] mx-auto px-6 py-8 font-primary bg-normalbg dark:bg-darkbg">
      ...
      <Form method="PUT" className="space-y-6 max-w-[768px] mx-auto">
        <div className="bg-white dark:bg-gray-700 p-6 rounded-md shadow-sm border border-gray-200 dark:border-gray-600 flex justify-between items-center mb-8">
          <div>
            <h3 className="text-xl font-bold text-primary dark:text-light mb-1">Your Loyalty Points</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Earn 1 point per $1 spent. Redeem for a 1¢ discount per point.</p>
          </div>
