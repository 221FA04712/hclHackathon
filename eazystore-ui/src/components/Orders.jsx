          ...
          {orders.map((order) => (
            ...
            >
              <div className="flex justify-between items-center mb-2">
                ...
                <button onClick={() => handleReorder(order)} className="px-4 py-2 bg-primary text-white font-medium rounded-md hover:bg-dark transition dark:bg-light dark:text-black dark:hover:bg-lighter">
                  Quick Reorder
                </button>
              </div>
